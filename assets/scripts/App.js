...
var smoothScrolling = new _SmoothScroll2.default();
...
var MobileMenu = function () {
  function MobileMenu() {
    ...
    this.menuContent = document.querySelector('.header-section__menu-content');
    this.events();
  }
  ...
  _createClass(MobileMenu, [{
    ...
    value: function toggleTheMenu() {
      this.menuContent.classList.toggle('header-section__menu-content--is-visible');
...
var SmoothScroll = function () {
  function SmoothScroll() {
    ...
    this.headerLinks = (0, _jquery2.default)('.header-section .nav a');
